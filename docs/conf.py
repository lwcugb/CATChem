...
extlinks = {
    'issue': ('https://github.com/ufs-community/CATChem/issues/%s', 'GH'),
    'pull': ('https://github.com/ufs-community/CATChem/pull/%s', 'PR'),
}
...
# of the sidebar.
html_logo = "../data/CATChem_logo.png"
